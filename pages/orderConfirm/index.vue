...
const router = useRouter();
  ...
  function getLocalstorageData() {
      ...
      let localStorageAddressData = JSON.parse(localStorage.getItem("userDetail"));
      address = localStorageAddressData;
      console.log("localStorageAddressData", localStorageAddressData)
    //   cartItem.value = localStorageData ? localStorageData : null
  }
